/*
  This class sorts user defined class (interface iquicksortable), and uses
...
class quicksort: public irunnable{

private:
  //iquicksortable object to sort
  iquicksortable<int>& object;
  
public:

  //Methods specific for quicksort algorithm:
  quicksort(iquicksortable<int>& starter);
  ~quicksort();
...
//################################################
quicksort::quicksort(iquicksortable<int>& starter)
  :object(starter){
}
